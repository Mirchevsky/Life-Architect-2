...
interface TaskDao {
    ...
    @Query(
        ...
        ORDER BY is_urgent DESC, is_pinned DESC, created_at DESC
        """
    )
     ...
     *
     * Ordered to match the in-app task list and widget:
     * urgent first, then pinned, then by creation date descending.
     *
